...
template <EdgeKind_aarch32 Kind> struct FixupInfoArm : public FixupInfoArmBase {
  static constexpr uint32_t Opcode = InstrTable[getInstrFromJITLinkEdgeKind(Kind)].Opcode;
  static constexpr uint32_t OpcodeMask = InstrTable[getInstrFromJITLinkEdgeKind(Kind)].OpcodeMask;
  static constexpr uint32_t ImmMask = InstrTable[getInstrFromJITLinkEdgeKind(Kind)].ImmMask;
  static constexpr uint32_t RegMask = InstrTable[getInstrFromJITLinkEdgeKind(Kind)].RegMask;
};
